describe('Interactive message quick reply', () => {
  ...
  it('should create new quick reply', () => {
    ...
    cy.get("button[class*='QuickReplyTemplate_AddButton']").as('addNewButton');
    cy.get('@addNewButton').click();
    cy.get('@addNewButton').click();

    cy.get("div[class*='QuickReplyTemplate_TextField'] input").eq(0).click().type('Button 1');
    cy.get("div[class*='QuickReplyTemplate_TextField'] input").eq(1).click().type('Button 2');
    cy.get("div[class*='QuickReplyTemplate_TextField'] input").eq(2).click().type('Button 3');
  ...
  it('should load interactive message list', () => {
    cy.get("p[class*='InteractiveMessageList_LabelText'").contains(interactiveMessageTitle);
  });
  ...
  it('should edit quick reply', () => {
    ...
    cy.get("div[class*='QuickReplyTemplate_TextField'] input").eq(0).click().type('3');
...
describe('Interactive message quick reply', () => {
  ...
  it('should create new quick reply', () => {
    ...
    cy.get("label[class*='nteractiveOptions_RadioLabel']").eq(1).click();

    // global button

    cy.get("div[class*='InteractiveOptions_GlobalButton'] input").click().type('Global Button');

    // list 1 title

    cy.get("div[class*='ListReplyTemplate_ListReplyWrapper'] input")
      .eq(0)
      .click()
      .type('List 1 title');

    cy.get("div[class*='ListReplyTemplate_TextFieldWrapper'] input")
      .eq(0)
      .click()
      .type('List 1 item 1 title');

    cy.get("div[class*='ListReplyTemplate_TextFieldWrapper'] input")
      .eq(1)
      .click()
      .type('List 1 item 1 description ');
  ...
  it('should edit quick reply', () => {
    ...
    cy.get("div[class*='InteractiveOptions_GlobalButton'] input").click().type('edit');
