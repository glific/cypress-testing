describe("Interactive message quick reply", () => {
  ...
  it("should load interactive message list", () => {
    cy.get("p[class*='InteractiveMessageList_LabelText'").contains(
      interactiveMessageTitle
    );
  });
...
describe("Interactive message quick reply", () => {
  ...
  it("should create new quick reply", () => {
    ...
    cy.get("div[class*='InteractiveOptions_GlobalButton'] input")
      .click()
      .type("Global Button");
